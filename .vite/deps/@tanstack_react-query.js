      ...
      __privateSet(
        ...
        createRetryer({
          ...
          onSuccess: (data) => {
            ...
            ;(_b2 = (_a13 = __privateGet(this, _cache).config).onSuccess) ==
            null
              ? void 0
...
var QueriesObserver =
    ...
    setQueries(queries, options) {
      ...
      if (true) {
        const queryHashes = queries.map(
          (query) =>
            __privateGet(this, _client3).defaultQueryOptions(query).queryHash
        )
  ...
  (findMatchingObservers_fn = function (queries) {
    const prevObserversMap = new Map(
      __privateGet(this, _observers2).map((observer) => [
    ...
    queries.forEach((options) => {
      const defaultedOptions = __privateGet(this, _client3).defaultQueryOptions(
        options
      )
  ...
  (notify_fn2 = function () {
    ...
    if (this.hasListeners()) {
      ...
      const newResult = __privateMethod(
        this,
        _QueriesObserver_instances,
        combineResult_fn
      ).call(
...
var ensureSuspenseTimers = (defaultedOptions) => {
  if (defaultedOptions.suspense) {
    const clamp = (value) =>
      value === 'static' ? value : Math.max(value ?? 1e3, 1e3)
